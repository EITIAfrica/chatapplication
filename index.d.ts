...
export interface ChatAppProps<TMessage extends IMessage = IMessage> {
  /* Messages to display */
  messages?: TMessage[];
  /* Input text; default is undefined, but if specified, it will override ChatApp's internal state */
  text?: string;
...
export class ChatApp extends React.Component<ChatAppProps> {
  static defaultProps: ChatAppProps;
